...
<div class="min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 text-slate-800 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 dark:text-slate-200">
    <nav class="bg-[#1E3A8A] text-white shadow-lg fixed w-full top-0 z-50">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            <a href="/" class="text-2xl font-semibold tracking-wide text-cyan-400">TrafficFlow</a>
            <div class="hidden md:flex space-x-6">
                <a href="/" class="hover:text-cyan-300 transition-colors font-medium">Home</a>
                <a href="/tickets" class="hover:text-cyan-300 transition-colors font-medium">Tickets</a>
                <a href="/dashboard" class="hover:text-cyan-300 transition-colors font-medium">Dashboard</a>
                <a href="/users" class="hover:text-cyan-300 transition-colors font-medium">Users</a>
            </div>
    ...
    <main class="container mx-auto px-6 py-16">
        <div class="max-w-4xl mx-auto">
            <h1 class="text-5xl font-extrabold text-emerald-700 dark:text-emerald-300 mb-12 text-center leading-tight">Empowering Efficient Traffic Management</h1>
    ...
    <footer class="bg-[#1E293B] text-white py-6 mt-20">
        <div class="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
            <p class="text-sm text-gray-400">&copy; 2025 TrafficFlow System. All rights reserved.</p>
            <div class="flex space-x-6 mt-4 md:mt-0">
                <a href="/about" class="text-gray-300 hover:text-cyan-400 transition-colors">About</a>
                <a href="/privacy" class="text-gray-300 hover:text-cyan-400 transition-colors">Privacy</a>
                <a href="/terms" class="text-gray-300 hover:text-cyan-400 transition-colors">Terms</a>
