...
<div class="min-h-screen flex flex-col bg-gradient-to-br from-slate-100 to-slate-200 text-slate-800 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 dark:text-slate-200">
    <main class="container mx-auto px-6 pt-16 pb-12 flex-grow">
        <div class="max-w-3xl mx-auto">
            <h1 class="text-4xl font-bold text-emerald-700 dark:text-emerald-300 mb-8">Privacy Policy</h1>
            
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-200 dark:border-gray-700">
                <p class="mb-4">We collect information necessary to process traffic violations and provide our services.</p>
                
                <p class="mb-4">Your data is secured using industry-standard methods and only used for legitimate purposes related to traffic enforcement.</p>
